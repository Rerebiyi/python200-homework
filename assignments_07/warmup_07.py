...
class CsvManager:
    ...
    def plot_data(self, y: str, x=None, plot_type: str = "line"):
        """
    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "between two columns in the active CSV."
            ),
            "parameters": {
                "type": "object",
                "properties": {
                    "col1": {
                        "type": "string",
                        "description": "First column for the correlation.",
                    },
                    "col2": {
                        "type": "string",
                        "description": "Second column for the correlation.",
                    },
                },
                "required": ["col1", "col2"],
            },
...
# system: gives the agent its instructions.
# user: contains the question the user asked.
# assistant: contains the model's response or tool request.
# tool: contains the result returned by a tool.
...
def compute_correlation(col1: str, col2: str) -> dict:
    ...
    Returns:
        A dict with the correlation coefficient and p-value, or an error dict.
    """
...
def list_csv_files() -> dict:
    ...
    Returns:
        A dict with a list of CSV files.
    """
...
def load_csv(filename: str) -> dict:
    ...
    Returns:
        A dict with a message and column names, or an error.
    """
...
def get_columns() -> list[str] | dict:
    """Return the column names from the loaded CSV.

    Returns:
        A list of column names, or an error.
    """
...
def describe_column(column: str) -> dict:
    ...
    Returns:
        A dict with statistics for the column.
    """
...
tool_agent = ToolCallingAgent(
    tools=TOOLS,
    model=model,
    instructions=SYSTEM_PROMPT_SMOL,
)
